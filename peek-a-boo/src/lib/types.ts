...
export type ServerOptions = "http://localhost:3000" | "http://65.1.92.65" | "http://192.168.101.62:3000" | string;
...
export let SettingsServers: ServerOptions[] = [ "http://localhost:3000", "http://65.1.92.65", "http://192.168.101.62:3000" ]
